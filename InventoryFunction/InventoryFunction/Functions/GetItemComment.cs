...
//                var response = req.CreateResponse(HttpStatusCode.BadRequest);
//                response.Headers.Add("Content-Type", "text/plain; charset=utf-8");
//                response.WriteString($"[200100008] GetItemComment InvalidOperationException: {ioe.Message}.");
//                return response;
//            }
//            catch (Exception e)
//            {
...
//                response.Headers.Add("Content-Type", "text/plain; charset=utf-8");
//                response.WriteString($"[200100009] GetItemComment Exception: {e.Message}.");
//                return response;
//            }
//        }
...
//                var response = req.CreateResponse(HttpStatusCode.BadRequest);
//                response.Headers.Add("Content-Type", "text/plain; charset=utf-8");
//                response.WriteString($"[200100011] GetItemCommentsByItem InvalidOperationException: {ioe.Message}.");
//                return response;
//            }
//            catch (Exception e)
//            {
//                var response = req.CreateResponse(HttpStatusCode.InternalServerError);
//                response.Headers.Add("Content-Type", "text/plain; charset=utf-8");
//                response.WriteString($"[200100012] GetItemCommentsByItem Exception: {e.Message}.");
//                return response;
//            }
//        }
//    }
